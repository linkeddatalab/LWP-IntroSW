(function () {
    ...
    function k(a, b, c) {
        ...
        l(this);
        this.setMap(a);
        this.K = this.b.getZoom();
        var f = this;
        google.maps.event.addListener(this.b,
            "zoom_changed", function () {
                var a = f.b.mapTypes[f.b.getMapTypeId()].maxZoom, b = f.b.getZoom();
                if (!(b < 0 || b > a) && f.K != b) f.K = f.b.getZoom(), f.m()
            });
    ...
    j.ba = e("J");
    j.I = function () {
        return this.J || this.b.mapTypes[this.b.getMapTypeId()].maxZoom
    };
    j.G = function (a, b) {
    ...
    j.Z = function (a, b) {
        for (var c = !1, f = 0, g; g = a[f]; f++) g = s(this, g), c = c || g;
    ...
    function n(a) {
        if (a.A) for (var b = a.v(new google.maps.LatLngBounds(a.b.getBounds().getSouthWest(), a.b.getBounds().getNorthEast())), c = 0, f; f = a.a[c]; c++) if (!f.s && b.contains(f.getPosition())) {
            for (var g = a, r = 4E4, o = d, v = 0, m = void 0; m = g.f[v]; v++) {
                var h = m.getCenter();
                if (h) {
                    var p = f.getPosition();
                    if (!h || !p) h = 0; else {
                        var w = (p.lat() - h.lat()) * Math.PI / 180, x = (p.lng() - h.lng()) * Math.PI / 180;
                        h = Math.sin(w / 2) * Math.sin(w / 2) + Math.cos(h.lat() * Math.PI / 180) * Math.cos(p.lat() * Math.PI / 180) * Math.sin(x / 2) * Math.sin(x / 2);
                        h = 6371 * 2 * Math.atan2(Math.sqrt(h),
                            Math.sqrt(1 - h))
                    }
                    h < r && (r = h, o = m)
                }
            }
            o && o.F.contains(f.getPosition()) ? o.q(f) : (m = new t(g), m.q(f), g.f.push(m))
        }
    }
    ...
    j.q = function (a) {
        ...
        b >= this.l && a.setMap(d);
        if (this.b.getZoom() > this.k.I()) for (a = 0; b = this.a[a]; a++) b.setMap(this.b); else if (this.a.length < this.l) z(this.n); else {
    ...
    function u(a, b, c) {
        a.k.extend(u, google.maps.OverlayView);
        this.j = b;
        this.fa = c || 0;
        this.u = a;
        this.d = d;
    ...
    j.onAdd = function () {
        ...
        if (this.t) this.c.style.cssText = A(this, B(this, this.d)), this.c.innerHTML = this.B.text;
    ...
    j.show = function () {
        if (this.c) this.c.style.cssText = A(this, B(this, this.d)), this.c.style.display = "";
        this.t = !0
    };
    j.remove = function () {
        this.setMap(d)
    ...
    j.onRemove = function () {
        if (this.c && this.c.parentNode) z(this), this.c.parentNode.removeChild(this.c), this.c = d
    };
    j.setCenter = e("d");
    ...
    t.prototype.getCenter = t.prototype.getCenter;
    t.prototype.getSize = t.prototype.T;
    t.prototype.getMarkers = t.prototype.o;
