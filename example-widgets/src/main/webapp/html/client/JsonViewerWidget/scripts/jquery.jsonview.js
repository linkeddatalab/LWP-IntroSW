...
*/
function JsonViewer(id, data) {

    var treeHTML = "<div class=\"jquery-jsonview\">" + json2markup(data) + "</div>";
    document.getElementById(id).innerHTML = treeHTML;


    function json2markup(json, lvl) {
    ...
    $('.list-toggle-button').on('click', function (e) {
        ...
        /** array of number, string does not need folder or unfolder */
        //toggle
